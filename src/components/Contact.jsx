...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_bl4pbzlвз', 'template_v8t1gwy', 
    {
      from_name: form.name,
      to_name: 'Nikita',
      from_email: form.email,
      to_email: 'blasthourly@gmail.com',
      ...
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form action="" ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea rows={7} name='message' value={form.message} onChange={handleChange} placeholder="What`s do you want to say?" 
            className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium" />
          </label>
